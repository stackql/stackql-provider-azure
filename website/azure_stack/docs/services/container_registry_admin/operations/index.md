...
<tr><td><b>Id</b></td><td><CopyableCode code="azure_stack.container_registry_admin.operations" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td></td>
    <td></td>
    <td>Get the list of supported admin container registry rest operations.</td>
</tr>
</tbody>
</table>
...
Get the list of supported admin container registry rest operations.
...
isDataAction,
origin
FROM azure_stack.container_registry_admin.operations
;
```
</TabItem>
</Tabs>
