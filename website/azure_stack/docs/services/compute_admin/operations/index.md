...
<tr><td><b>Id</b></td><td><CopyableCode code="azure_stack.compute_admin.operations" /></td></tr>
</tbody></table>
...
<tr>
    <td><a href="#enable_tenant_subscription_feature"><CopyableCode code="enable_tenant_subscription_feature" /></a></td>
    <td><CopyableCode code="exec" /></td>
    <td><a href="#parameter-subscriptionId"><code>subscriptionId</code></a>, <a href="#parameter-location"><code>location</code></a>, <a href="#parameter-featureName"><code>featureName</code></a></td>
    <td></td>
    <td>Enable the tenant subscription feature.</td>
</tr>
<tr>
    <td><a href="#disable_tenant_subscription_feature"><CopyableCode code="disable_tenant_subscription_feature" /></a></td>
    <td><CopyableCode code="exec" /></td>
    <td><a href="#parameter-subscriptionId"><code>subscriptionId</code></a>, <a href="#parameter-location"><code>location</code></a>, <a href="#parameter-featureName"><code>featureName</code></a></td>
    <td></td>
    <td>Disable the tenant subscription feature.</td>
</tr>
</tbody>
</table>
...
<Tabs
    defaultValue="enable_tenant_subscription_feature"
    values={[
        { label: 'enable_tenant_subscription_feature', value: 'enable_tenant_subscription_feature' },
        { label: 'disable_tenant_subscription_feature', value: 'disable_tenant_subscription_feature' }
    ]}
>
<TabItem value="enable_tenant_subscription_feature">
...
<TabItem value="disable_tenant_subscription_feature">
