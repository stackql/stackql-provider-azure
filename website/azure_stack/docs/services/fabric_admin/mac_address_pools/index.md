...
<tr>
    ...
    <td>Properties of a MAC address pool.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><a href="#parameter-subscriptionId"><code>subscriptionId</code></a>, <a href="#parameter-resourceGroupName"><code>resourceGroupName</code></a>, <a href="#parameter-location"><code>location</code></a>, <a href="#parameter-macAddressPool"><code>macAddressPool</code></a></td>
    <td></td>
    <td>Returns the requested MAC address pool.</td>
</tr>
<tr>
    ...
    <td>Returns a list of all MAC address pools at a location.</td>
</tr>
</tbody>
</table>
...
<tr id="parameter-macAddressPool">
    <td><CopyableCode code="macAddressPool" /></td>
    <td><code>string</code></td>
    <td>Name of the MAC address pool.</td>
</tr>
...
AND macAddressPool = '{{ macAddressPool }}' -- required
;
```
</TabItem>
<TabItem value="list">
