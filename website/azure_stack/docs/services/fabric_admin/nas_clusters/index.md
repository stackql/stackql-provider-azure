...
<tr>
    ...
    <td>Properties of a nas cluster.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><a href="#parameter-subscriptionId"><code>subscriptionId</code></a>, <a href="#parameter-resourceGroupName"><code>resourceGroupName</code></a>, <a href="#parameter-location"><code>location</code></a>, <a href="#parameter-nasCluster"><code>nasCluster</code></a></td>
    <td></td>
    <td>Return the requested nas cluster.</td>
</tr>
<tr>
    ...
    <td>Returns a list of all nas clusters at a location.</td>
</tr>
</tbody>
</table>
...
<tr id="parameter-nasCluster">
    <td><CopyableCode code="nasCluster" /></td>
    <td><code>string</code></td>
    <td>Name of the nas cluster.</td>
</tr>
...
AND nasCluster = '{{ nasCluster }}' -- required
;
```
</TabItem>
<TabItem value="list">
