...
<tr>
    ...
    <td>The properties of the time settings of a device.</td>
</tr>
<tr>
...
<tr>
    ...
    <td></td>
    <td>Gets the time settings of the specified device.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Creates or updates the time settings of the specified device.</td>
</tr>
</tbody>
</table>
...
- name: device_settings_time_settings
  props:
    - name: deviceName
      value: string
      description: Required parameter for the device_settings_time_settings resource.
    - name: subscriptionId
      value: string
      description: Required parameter for the device_settings_time_settings resource.
