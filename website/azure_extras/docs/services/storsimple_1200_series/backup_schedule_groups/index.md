...
<tr>
    ...
    <td>Properties of BackupScheduleGroup</td>
</tr>
<tr>
...
The collection of backup schedule groups.
...
<tr>
    ...
    <td><a href="#parameter-deviceName"><code>deviceName</code></a>, <a href="#parameter-scheduleGroupName"><code>scheduleGroupName</code></a>, <a href="#parameter-subscriptionId"><code>subscriptionId</code></a>, <a href="#parameter-resourceGroupName"><code>resourceGroupName</code></a>, <a href="#parameter-managerName"><code>managerName</code></a></td>
    <td></td>
    <td>Returns the properties of the specified backup schedule group name.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><a href="#parameter-deviceName"><code>deviceName</code></a>, <a href="#parameter-scheduleGroupName"><code>scheduleGroupName</code></a>, <a href="#parameter-subscriptionId"><code>subscriptionId</code></a>, <a href="#parameter-resourceGroupName"><code>resourceGroupName</code></a>, <a href="#parameter-managerName"><code>managerName</code></a></td>
    <td></td>
    <td>Deletes the backup schedule group.</td>
</tr>
</tbody>
</table>
...
<tr id="parameter-scheduleGroupName">
    <td><CopyableCode code="scheduleGroupName" /></td>
    <td><code>string</code></td>
    <td>The name of the schedule group.</td>
</tr>
...
- name: backup_schedule_groups
  props:
    - name: deviceName
      value: string
      description: Required parameter for the backup_schedule_groups resource.
