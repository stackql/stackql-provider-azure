...
Creates, updates, deletes, gets or lists an <code>iscsi_servers_metric_definitions</code> resource.
...
<tr>
    ...
    <td></td>
    <td>Retrieves metric definitions for all metrics aggregated at iSCSI server.</td>
</tr>
</tbody>
</table>
