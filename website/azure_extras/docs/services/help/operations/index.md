...
<tr><td><b>Id</b></td><td><CopyableCode code="azure_extras.help.operations" /></td></tr>
</tbody></table>
...
<tr>
    <td><a href="#check_name_availability_check_availability"><CopyableCode code="check_name_availability_check_availability" /></a></td>
...
isDataAction,
origin
FROM azure_extras.help.operations
;
```
</TabItem>
</Tabs>
...
<Tabs
    defaultValue="check_name_availability_check_availability"
    values={[
        { label: 'check_name_availability_check_availability', value: 'check_name_availability_check_availability' }
    ]}
>
<TabItem value="check_name_availability_check_availability">

This API is used to check the uniqueness of a resource name used for a diagnostic, troubleshooter or solutions

```sql
EXEC azure_extras.help.operations.check_name_availability_check_availability 
