...
<tr>
    ...
    <td>Document processor properties.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><a href="#parameter-subscriptionId"><code>subscriptionId</code></a>, <a href="#parameter-resourceGroupName"><code>resourceGroupName</code></a>, <a href="#parameter-processorName"><code>processorName</code></a></td>
    <td></td>
    <td>Returns a document processor for a given name.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Returns document processors in a resource group.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Returns document processors in the subscription.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-subscriptionId"><code>subscriptionId</code></a>, <a href="#parameter-resourceGroupName"><code>resourceGroupName</code></a>, <a href="#parameter-processorName"><code>processorName</code></a></td>
    <td></td>
    <td>Creates a document processor resource for a given name.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-subscriptionId"><code>subscriptionId</code></a>, <a href="#parameter-resourceGroupName"><code>resourceGroupName</code></a>, <a href="#parameter-processorName"><code>processorName</code></a></td>
    <td></td>
    <td>Updates a document processor resource for a given name.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-subscriptionId"><code>subscriptionId</code></a>, <a href="#parameter-resourceGroupName"><code>resourceGroupName</code></a>, <a href="#parameter-processorName"><code>processorName</code></a></td>
    <td></td>
    <td>Deletes document processor resource for a given name.</td>
</tr>
</tbody>
</table>
...
<tbody>
<tr id="parameter-processorName">
    <td><CopyableCode code="processorName" /></td>
    <td><code>string</code></td>
    <td>The name of document processor resource.</td>
</tr>
...
AND processorName = '{{ processorName }}' -- required
;
```
</TabItem>
<TabItem value="list_by_resource_group">
...
- name: document_processors
  props:
    - name: subscriptionId
      value: string
      description: Required parameter for the document_processors resource.
