...
<tr>
    ...
    <td>Properties of an OS Update.</td>
</tr>
</tbody>
</table>
</TabItem>
...
<tr>
    ...
    <td><a href="#parameter-subscriptionId"><code>subscriptionId</code></a>, <a href="#parameter-resourceGroupName"><code>resourceGroupName</code></a>, <a href="#parameter-testBaseAccountName"><code>testBaseAccountName</code></a>, <a href="#parameter-packageName"><code>packageName</code></a>, <a href="#parameter-osUpdateResourceName"><code>osUpdateResourceName</code></a></td>
    <td></td>
...
<tbody>
<tr id="parameter-osUpdateResourceName">
    <td><CopyableCode code="osUpdateResourceName" /></td>
    <td><code>string</code></td>
    <td>The resource name of an OS Update.</td>
</tr>
...
AND osUpdateResourceName = '{{ osUpdateResourceName }}' -- required
;
```
</TabItem>
<TabItem value="list">
