...
<tr>
    ...
    <td>Properties of a Test Summary.</td>
</tr>
</tbody>
</table>
</TabItem>
...
<tr>
    ...
    <td><a href="#parameter-subscriptionId"><code>subscriptionId</code></a>, <a href="#parameter-resourceGroupName"><code>resourceGroupName</code></a>, <a href="#parameter-testBaseAccountName"><code>testBaseAccountName</code></a>, <a href="#parameter-testSummaryName"><code>testSummaryName</code></a></td>
    <td></td>
...
<tr id="parameter-testSummaryName">
    <td><CopyableCode code="testSummaryName" /></td>
    <td><code>string</code></td>
    <td>The name of the Test Summary.</td>
</tr>
</tbody>
</table>
...
AND testSummaryName = '{{ testSummaryName }}' -- required
;
```
</TabItem>
<TabItem value="list">
