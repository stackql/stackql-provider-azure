...
<tr>
    ...
    <td><a href="#parameter-subscriptionId"><code>subscriptionId</code></a>, <a href="#parameter-resourceGroupName"><code>resourceGroupName</code></a>, <a href="#parameter-testBaseAccountName"><code>testBaseAccountName</code></a>, <a href="#parameter-testTypeResourceName"><code>testTypeResourceName</code></a></td>
    <td></td>
...
<tr id="parameter-testTypeResourceName">
    <td><CopyableCode code="testTypeResourceName" /></td>
    <td><code>string</code></td>
    <td>The resource name of a test type.</td>
</tr>
</tbody>
</table>
...
AND testTypeResourceName = '{{ testTypeResourceName }}' -- required
;
```
</TabItem>
<TabItem value="list">
