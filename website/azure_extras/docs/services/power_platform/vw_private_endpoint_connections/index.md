...
<tr><td><b>Id</b></td><td><CopyableCode code="azure_extras.power_platform.vw_private_endpoint_connections" /></td></tr>
</tbody></table>
...
WHERE subscriptionId = 'replace-me' AND resourceGroupName = 'replace-me' AND enterprisePolicyName = 'replace-me';
```
