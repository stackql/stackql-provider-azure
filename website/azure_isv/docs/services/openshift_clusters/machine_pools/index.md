...
<tr>
    ...
    <td>The MachinePool Properties</td>
</tr>
<tr>
...
<tr>
    ...
    <td></td>
    <td>The operation returns properties of a MachinePool.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>The operation returns properties of each MachinePool.</td>
</tr>
<tr>
...
<tr id="parameter-childResourceName">
    ...
    <td>The name of the MachinePool resource.</td>
</tr>
...
- name: machine_pools
  props:
    - name: subscriptionId
      value: string
      description: Required parameter for the machine_pools resource.
