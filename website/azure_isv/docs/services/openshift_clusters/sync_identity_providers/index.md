...
<tr>
    ...
    <td>The SyncIdentityProvider Properties</td>
</tr>
<tr>
...
<tr>
    ...
    <td></td>
    <td>The operation returns properties of a SyncIdentityProvider.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>The operation returns properties of each SyncIdentityProvider.</td>
</tr>
<tr>
...
<tr id="parameter-childResourceName">
    ...
    <td>The name of the SyncIdentityProvider resource.</td>
</tr>
...
- name: sync_identity_providers
  props:
    - name: subscriptionId
      value: string
      description: Required parameter for the sync_identity_providers resource.
