...
<tr>
    ...
    <td>Flag indicating if resource is sending logs to Datadog.</td>
</tr>
<tr>
    <td><CopyableCode code="sendingMetrics" /></td>
    <td><code>boolean</code></td>
    <td>Flag indicating if resource is sending metrics to Datadog.</td>
</tr>
</tbody>
</table>
</TabItem>
...
sendingLogs,
sendingMetrics
FROM azure_isv.datadog.monitors_monitored_resources
