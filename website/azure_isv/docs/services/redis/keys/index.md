...
<tr>
    ...
    <td>The current primary key that clients can use to authenticate with Redis cache.</td>
</tr>
<tr>
    <td><CopyableCode code="secondaryKey" /></td>
    <td><code>string</code></td>
    <td>The current secondary key that clients can use to authenticate with Redis cache.</td>
</tr>
</tbody>
</table>
</TabItem>
