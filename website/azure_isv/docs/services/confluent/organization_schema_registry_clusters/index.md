...
Creates, updates, deletes, gets or lists an <code>organization_schema_registry_clusters</code> resource.
...
<tr id="parameter-pageToken">
    ...
    <td><code>string</code></td>
    <td>An opaque pagination token to fetch the next set of records</td>
</tr>
</tbody>
</table>
