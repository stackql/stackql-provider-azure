...
Creates, updates, deletes, gets or lists an <code>organizations_elastic_to_azure_subscription_mappings</code> resource.
...
<tr>
    ...
    <td>The properties of Azure Subscription ID to which the Organization of the logged in user belongs and gets billed into.</td>
</tr>
</tbody>
</table>
</TabItem>
...
<tr>
    ...
    <td></td>
    <td>Get Elastic Organization To Azure Subscription Mapping details for the logged-in user.</td>
</tr>
</tbody>
</table>
