...
<tbody>
<tr>
    <td><CopyableCode code="filteringTags" /></td>
    <td><code>array</code></td>
    <td>List of filtering tags to be used for capturing metrics. (x-cadl-name: FilteringTag[])</td>
</tr>
<tr>
    <td><CopyableCode code="sendMetrics" /></td>
    <td><code>string</code></td>
    <td>Flag specifying if metrics should be sent for the Monitor resource.</td>
</tr>
<tr>
    <td><CopyableCode code="userEmail" /></td>
    <td><code>string</code></td>
    <td>User Email (pattern: <code>^[A-Za-z0-9._%+-]+@(?:[A-Za-z0-9-]+\.)+[A-Za-z]&#123;2,&#125;$</code>)</td>
</tr>
</tbody>
</table>
</TabItem>
