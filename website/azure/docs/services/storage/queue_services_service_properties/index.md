...
<tr>
    ...
    <td><code></code></td>
    <td>The properties of a storage account’s Queue service. (x-ms-client-name: QueueServiceProperties)</td>
</tr>
<tr>
...
<tr>
    ...
    <td><a href="#parameter-resourceGroupName"><code>resourceGroupName</code></a>, <a href="#parameter-accountName"><code>accountName</code></a>, <a href="#parameter-subscriptionId"><code>subscriptionId</code></a>, <a href="#parameter-queueServiceName"><code>queueServiceName</code></a></td>
    <td></td>
...
<tr id="parameter-queueServiceName">
    <td><CopyableCode code="queueServiceName" /></td>
    <td><code>string</code></td>
    <td>The name of the Queue Service within the specified storage account. Queue Service Name must be 'default'</td>
</tr>
...
AND queueServiceName = '{{ queueServiceName }}' -- required
;
```
</TabItem>
</Tabs>
