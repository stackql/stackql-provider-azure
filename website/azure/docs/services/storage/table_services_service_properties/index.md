...
Creates, updates, deletes, gets or lists a <code>table_services_service_properties</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><code>table_services_service_properties</code></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.storage.table_services_service_properties" /></td></tr>
</tbody></table>
...
systemData,
type
FROM azure.storage.table_services_service_properties
WHERE resourceGroupName = '{{ resourceGroupName }}' -- required
AND accountName = '{{ accountName }}' -- required
AND subscriptionId = '{{ subscriptionId }}' -- required
AND tableServiceName = '{{ tableServiceName }}' -- required
;
```
</TabItem>
</Tabs>
