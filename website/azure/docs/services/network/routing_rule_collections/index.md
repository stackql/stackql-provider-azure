...
<tr>
    ...
    <td>Indicates the properties for the network manager routing rule collection.</td>
</tr>
<tr>
...
Get successful. The operation returns all ruleCollections in the specified routing configuration, in a paginated format
...
<tr id="parameter-configurationName">
    ...
    <td><code>string</code></td>
    <td>The name of the network manager Routing Configuration.</td>
</tr>
