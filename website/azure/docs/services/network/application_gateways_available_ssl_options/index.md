...
Creates, updates, deletes, gets or lists an <code>application_gateways_available_ssl_options</code> resource.
...
<tr>
    ...
    <td>Properties of the application gateway available SSL options.</td>
</tr>
<tr>
