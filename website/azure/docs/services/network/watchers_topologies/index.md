...
<tr>
    ...
    <td>GUID representing the operation id.</td>
</tr>
<tr>
    <td><CopyableCode code="createdDateTime" /></td>
    <td><code>string (date-time)</code></td>
    <td>The datetime when the topology was initially created for the resource group.</td>
</tr>
<tr>
    <td><CopyableCode code="lastModified" /></td>
    <td><code>string (date-time)</code></td>
    <td>The datetime when the topology was last modified.</td>
</tr>
<tr>
    <td><CopyableCode code="resources" /></td>
    <td><code>array</code></td>
    <td>A list of topology resources.</td>
</tr>
</tbody>
</table>
</TabItem>
