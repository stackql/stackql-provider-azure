...
<tr>
    ...
    <td>Indicates the properties for the network manager security user configuration.</td>
</tr>
<tr>
...
Get successful. The operation returns all security user configurations in the specified network manager, in a paginated format
