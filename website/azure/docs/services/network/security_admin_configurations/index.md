...
<tr>
    ...
    <td>Indicates the properties for the network manager security admin configuration.</td>
</tr>
<tr>
...
Get successful. The operation returns all security admin configuration resources in the specified network manager, in a paginated format
