...
<tr>
    ...
    <td>Properties of the hub virtual network connection.</td>
</tr>
</tbody>
</table>
</TabItem>
...
Request successful. Returns the details of all the HubVirtualNetworkConnections for the VirtualHub.
...
<tr id="parameter-connectionName">
    ...
    <td><code>string</code></td>
    <td>The name of the HubVirtualNetworkConnection.</td>
</tr>
