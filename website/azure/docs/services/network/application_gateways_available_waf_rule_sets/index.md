...
Creates, updates, deletes, gets or lists an <code>application_gateways_available_waf_rule_sets</code> resource.
...
<tr>
    ...
    <td>Properties of the application gateway firewall rule set.</td>
</tr>
<tr>
