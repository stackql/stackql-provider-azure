...
<tr>
    ...
    <td><a href="#parameter-targetLocations"><code>targetLocations</code></a>, <a href="#parameter-commitType"><code>commitType</code></a></td>
    <td></td>
...
```sql
EXEC azure.network.manager_commits.post 
@@json=
'{
