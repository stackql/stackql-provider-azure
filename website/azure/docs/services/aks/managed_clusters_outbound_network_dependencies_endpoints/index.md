...
<tr>
    ...
    <td>The category of endpoints accessed by the AKS agent node, e.g. azure-resource-management, apiserver, etc.</td>
</tr>
<tr>
    <td><CopyableCode code="endpoints" /></td>
    <td><code>array</code></td>
    <td>The endpoints that AKS agent nodes connect to</td>
</tr>
</tbody>
</table>
</TabItem>
...
<tr>
    ...
    <td></td>
    <td>Gets a list of egress endpoints (network endpoints of all outbound dependencies) in the specified managed cluster. The operation returns properties of each egress endpoint.</td>
</tr>
</tbody>
</table>
