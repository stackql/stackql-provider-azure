...
<tr>
    ...
    <td></td>
    <td></td>
    <td>List all the operations.</td>
</tr>
<tr>
    <td><a href="#validate_purchase"><CopyableCode code="validate_purchase" /></a></td>
...
<Tabs
    defaultValue="validate_purchase"
    values={[
        { label: 'validate_purchase', value: 'validate_purchase' }
    ]}
>
<TabItem value="validate_purchase">

Validate savings plan purchase.

```sql
EXEC azure.billing_benefits.operations.validate_purchase 
@@json=
'{
"benefits": "{{ benefits }}"
}'
