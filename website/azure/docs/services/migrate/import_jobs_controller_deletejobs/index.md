...
Creates, updates, deletes, gets or lists an <code>import_jobs_controller_deletejobs</code> resource.
...
<tr>
    ...
    <td></td>
    <td>Gets the delete imported machines job with the given job name.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Method to get all delete import machines job for the given site.</td>
</tr>
</tbody>
</table>
