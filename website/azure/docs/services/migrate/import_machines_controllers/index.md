...
Creates, updates, deletes, gets or lists an <code>import_machines_controllers</code> resource.
...
<Tabs
    ...
    values={[
        { label: 'get', value: 'get' },
        { label: 'list_by_import_site', value: 'list_by_import_site' }
    ]}
>
<TabItem value="get">
...
<TabItem value="list_by_import_site">
...
<tr>
    ...
    <td></td>
    <td>Get a ImportMachine</td>
</tr>
<tr>
    <td><a href="#list_by_import_site"><CopyableCode code="list_by_import_site" /></a></td>
    <td><CopyableCode code="select" /></td>
    ...
    <td>List ImportMachine resources by ImportSite</td>
</tr>
<tr>
