...
<Tabs
    defaultValue="list_by_machine_resource"
    values={[
        { label: 'list_by_machine_resource', value: 'list_by_machine_resource' }
    ]}
>
<TabItem value="list_by_machine_resource">
...
<tbody>
<tr>
    <td><a href="#list_by_machine_resource"><CopyableCode code="list_by_machine_resource" /></a></td>
    ...
    <td></td>
    <td>List VmwareMachineSoftwareInventory resources by MachineResource</td>
</tr>
</tbody>
</table>
