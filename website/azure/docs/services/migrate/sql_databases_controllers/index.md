...
<tr>
    ...
    <td><a href="#parameter-subscriptionId"><code>subscriptionId</code></a>, <a href="#parameter-resourceGroupName"><code>resourceGroupName</code></a>, <a href="#parameter-siteName"><code>siteName</code></a>, <a href="#parameter-sqlSiteName"><code>sqlSiteName</code></a>, <a href="#parameter-sqlDatabaseName"><code>sqlDatabaseName</code></a></td>
    <td></td>
    <td>Gets the sql Database.</td>
</tr>
<tr>
...
<tr id="parameter-sqlDatabaseName">
...
AND sqlDatabaseName = '{{ sqlDatabaseName }}' -- required
;
```
</TabItem>
<TabItem value="list_by_sql_site">
