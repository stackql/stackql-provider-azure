...
<tr>
    ...
    <td><a href="#parameter-subscriptionId"><code>subscriptionId</code></a>, <a href="#parameter-resourceGroupName"><code>resourceGroupName</code></a>, <a href="#parameter-workspaceName"><code>workspaceName</code></a>, <a href="#parameter-bookmarkId"><code>bookmarkId</code></a></td>
    <td></td>
...
<tbody>
<tr id="parameter-bookmarkId">
    <td><CopyableCode code="bookmarkId" /></td>
    <td><code>string</code></td>
    <td>Bookmark ID</td>
</tr>
...
AND bookmarkId = '{{ bookmarkId }}' -- required
;
```
</TabItem>
<TabItem value="list">
