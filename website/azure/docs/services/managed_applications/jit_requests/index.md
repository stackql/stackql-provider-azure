...
OK - Returns an array of JIT requests.
...
<tr>
    ...
    <td><a href="#parameter-subscriptionId"><code>subscriptionId</code></a>, <a href="#parameter-resourceGroupName"><code>resourceGroupName</code></a>, <a href="#parameter-jitRequestName"><code>jitRequestName</code></a></td>
    <td></td>
...
<tbody>
<tr id="parameter-jitRequestName">
    <td><CopyableCode code="jitRequestName" /></td>
    <td><code>string</code></td>
    <td>The name of the JIT request.</td>
</tr>
...
AND jitRequestName = '{{ jitRequestName }}' -- required
;
```
</TabItem>
<TabItem value="list_by_resource_group">
