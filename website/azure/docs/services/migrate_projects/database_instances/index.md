...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.migrate_projects.database_instances" /></td></tr>
</tbody></table>
...
<tbody>
<tr>
    <td><a href="#enumerate_database_instances"><CopyableCode code="enumerate_database_instances" /></a></td>
...
<Tabs
    defaultValue="enumerate_database_instances"
    values={[
        { label: 'enumerate_database_instances', value: 'enumerate_database_instances' }
    ]}
>
<TabItem value="enumerate_database_instances">

OK

```sql
EXEC azure.migrate_projects.database_instances.enumerate_database_instances 
