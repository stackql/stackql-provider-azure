...
<tr>
    ...
    <td><a href="#parameter-subscriptionId"><code>subscriptionId</code></a>, <a href="#parameter-type"><code>type</code></a></td>
    <td></td>
...
```sql
EXEC azure.terraform.operations.export_terraform 
