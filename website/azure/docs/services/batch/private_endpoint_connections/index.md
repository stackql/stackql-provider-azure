...
<tr>
    ...
    <td>The properties associated with the private endpoint connection.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><a href="#parameter-subscriptionId"><code>subscriptionId</code></a>, <a href="#parameter-resourceGroupName"><code>resourceGroupName</code></a>, <a href="#parameter-accountName"><code>accountName</code></a>, <a href="#parameter-privateEndpointConnectionName"><code>privateEndpointConnectionName</code></a></td>
    <td></td>
...
<tr id="parameter-privateEndpointConnectionName">
    ...
    <td><code>string</code></td>
    <td>The private endpoint connection name. This must be unique within the account.</td>
</tr>
...
<tr id="parameter-If-Match">
    ...
    <td><code>string</code></td>
    <td>The state (ETag) version of the private endpoint connection to update. This value can be omitted or set to "*" to apply the operation unconditionally.</td>
</tr>
