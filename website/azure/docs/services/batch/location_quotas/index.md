...
<tbody>
<tr>
    <td><CopyableCode code="accountQuota" /></td>
    <td><code>integer (int32)</code></td>
    <td>The number of Batch accounts that may be created under the subscription in the specified region.</td>
</tr>
</tbody>
</table>
</TabItem>
...
<tr id="parameter-locationName">
    ...
    <td>The region for which to retrieve Batch service quotas.</td>
</tr>
