...
Creates, updates, deletes, gets or lists an <code>email_services_verified_exchange_online_domains</code> resource.
...
<tr>
    ...
    <td></td>
    <td>Get a list of domains that are fully verified in Exchange Online.</td>
</tr>
</tbody>
</table>
