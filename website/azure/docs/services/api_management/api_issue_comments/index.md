...
Creates, updates, deletes, gets or lists an <code>api_issue_comments</code> resource.
...
The response body contains the specified issue Comment entity.
...
<tr>
    ...
    <td>Properties of the Issue Comment.</td>
</tr>
</tbody>
</table>
</TabItem>
...
Paged Result response of issue comments for the API.
...
<tr id="parameter-commentId">
    ...
    <td><code>string</code></td>
    <td>Comment identifier within an Issue. Must be unique in the current Issue.</td>
</tr>
...
- name: api_issue_comments
  props:
    - name: resourceGroupName
      value: string
      description: Required parameter for the api_issue_comments resource.
    - name: serviceName
      value: string
      description: Required parameter for the api_issue_comments resource.
    - name: apiId
