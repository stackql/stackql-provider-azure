...
Creates, updates, deletes, gets or lists an <code>api_issue_attachments</code> resource.
...
<tr>
    ...
    <td>Properties of the Issue Attachment.</td>
</tr>
</tbody>
</table>
</TabItem>
...
Paged Result response of issue attachments for the API.
...
<tr>
    ...
    <td><a href="#parameter-resourceGroupName"><code>resourceGroupName</code></a>, <a href="#parameter-serviceName"><code>serviceName</code></a>, <a href="#parameter-apiId"><code>apiId</code></a>, <a href="#parameter-issueId"><code>issueId</code></a>, <a href="#parameter-attachmentId"><code>attachmentId</code></a>, <a href="#parameter-subscriptionId"><code>subscriptionId</code></a></td>
    <td></td>
...
<tr>
    ...
    <td><CopyableCode code="select" /></td>
    <td><a href="#parameter-resourceGroupName"><code>resourceGroupName</code></a>, <a href="#parameter-serviceName"><code>serviceName</code></a>, <a href="#parameter-apiId"><code>apiId</code></a>, <a href="#parameter-issueId"><code>issueId</code></a>, <a href="#parameter-subscriptionId"><code>subscriptionId</code></a></td>
...
<tr>
    ...
    <td><a href="#parameter-resourceGroupName"><code>resourceGroupName</code></a>, <a href="#parameter-serviceName"><code>serviceName</code></a>, <a href="#parameter-apiId"><code>apiId</code></a>, <a href="#parameter-issueId"><code>issueId</code></a>, <a href="#parameter-attachmentId"><code>attachmentId</code></a>, <a href="#parameter-If-Match"><code>If-Match</code></a>, <a href="#parameter-subscriptionId"><code>subscriptionId</code></a></td>
    <td></td>
...
<tr id="parameter-attachmentId">
    ...
    <td><code>string</code></td>
    <td>Attachment identifier within an Issue. Must be unique in the current Issue.</td>
</tr>
...
<tr id="parameter-$filter">
    ...
    <td><code>string</code></td>
    <td>|     Field     |     Usage     |     Supported operators     |     Supported functions     |&lt;/br&gt;|-------------|-------------|-------------|-------------|&lt;/br&gt;| name | filter | ge, le, eq, ne, gt, lt | substringof, contains, startswith, endswith |&lt;/br&gt;| userId | filter | ge, le, eq, ne, gt, lt | substringof, contains, startswith, endswith |&lt;/br&gt;</td>
</tr>
...
- name: api_issue_attachments
  props:
    - name: resourceGroupName
      value: string
      description: Required parameter for the api_issue_attachments resource.
    - name: serviceName
      value: string
      description: Required parameter for the api_issue_attachments resource.
    - name: apiId
