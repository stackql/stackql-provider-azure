...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.relay.namespaces_authorization_rules" /></td></tr>
</tbody></table>
...
properties,
systemData
FROM azure.relay.namespaces_authorization_rules
...
```sql
INSERT INTO azure.relay.namespaces_authorization_rules (
data__properties,
resourceGroupName,
namespaceName,
...
```sql
DELETE FROM azure.relay.namespaces_authorization_rules
WHERE resourceGroupName = '{{ resourceGroupName }}' --required
AND namespaceName = '{{ namespaceName }}' --required
AND authorizationRuleName = '{{ authorizationRuleName }}' --required
AND subscriptionId = '{{ subscriptionId }}' --required
