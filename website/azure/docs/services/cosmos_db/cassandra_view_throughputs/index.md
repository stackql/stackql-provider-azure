...
The RUs per second of the Cassandra view was retrieved successfully.
...
<tr>
    ...
    <td></td>
    <td>Gets the RUs per second of the Cassandra view under an existing Azure Cosmos DB database account with the provided name.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Update RUs per second of an Azure Cosmos DB Cassandra view</td>
</tr>
</tbody>
</table>
