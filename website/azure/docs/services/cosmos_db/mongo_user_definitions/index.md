...
<tr>
    ...
    <td>Properties related to the User Definition.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><a href="#parameter-mongoUserDefinitionId"><code>mongoUserDefinitionId</code></a>, <a href="#parameter-subscriptionId"><code>subscriptionId</code></a>, <a href="#parameter-resourceGroupName"><code>resourceGroupName</code></a>, <a href="#parameter-accountName"><code>accountName</code></a></td>
    <td></td>
...
<tr id="parameter-mongoUserDefinitionId">
    <td><CopyableCode code="mongoUserDefinitionId" /></td>
    <td><code>string</code></td>
    <td>The ID for the User Definition &#123;dbName.userName&#125;.</td>
</tr>
...
- name: mongo_user_definitions
  props:
    - name: mongoUserDefinitionId
      value: string
      description: Required parameter for the mongo_user_definitions resource.
    - name: subscriptionId
      value: string
      description: Required parameter for the mongo_user_definitions resource.
