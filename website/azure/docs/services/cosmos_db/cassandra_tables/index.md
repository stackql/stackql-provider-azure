...
Creates, updates, deletes, gets or lists a <code>cassandra_tables</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><code>cassandra_tables</code></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.cosmos_db.cassandra_tables" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><code>object</code></td>
    <td>The properties of an Azure Cosmos DB Cassandra table</td>
</tr>
<tr>
...
```sql
INSERT INTO azure.cosmos_db.cassandra_tables (
data__properties,
data__location,
data__tags,
data__identity,
...
- name: cassandra_tables
  props:
    - name: subscriptionId
      value: string
      description: Required parameter for the cassandra_tables resource.
...
```sql
DELETE FROM azure.cosmos_db.cassandra_tables
WHERE subscriptionId = '{{ subscriptionId }}' --required
AND resourceGroupName = '{{ resourceGroupName }}' --required
AND accountName = '{{ accountName }}' --required
AND keyspaceName = '{{ keyspaceName }}' --required
