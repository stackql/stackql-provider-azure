...
Creates, updates, deletes, gets or lists a <code>mongodb_databases</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><code>mongodb_databases</code></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.cosmos_db.mongodb_databases" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><code>object</code></td>
    <td>The properties of an Azure Cosmos DB MongoDB database</td>
</tr>
<tr>
...
```sql
INSERT INTO azure.cosmos_db.mongodb_databases (
data__properties,
data__location,
data__tags,
data__identity,
...
- name: mongodb_databases
  props:
    - name: subscriptionId
      value: string
      description: Required parameter for the mongodb_databases resource.
...
```sql
DELETE FROM azure.cosmos_db.mongodb_databases
WHERE subscriptionId = '{{ subscriptionId }}' --required
AND resourceGroupName = '{{ resourceGroupName }}' --required
AND accountName = '{{ accountName }}' --required
AND databaseName = '{{ databaseName }}' --required
