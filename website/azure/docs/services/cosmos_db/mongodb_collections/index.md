...
Creates, updates, deletes, gets or lists a <code>mongodb_collections</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><code>mongodb_collections</code></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.cosmos_db.mongodb_collections" /></td></tr>
</tbody></table>
...
The MongoDB collection property was retrieved successfully.
...
<tr>
    ...
    <td><code>object</code></td>
    <td>The properties of an Azure Cosmos DB MongoDB collection</td>
</tr>
<tr>
...
The MongoDB collection properties were retrieved successfully.
...
```sql
INSERT INTO azure.cosmos_db.mongodb_collections (
data__properties,
data__location,
data__tags,
data__identity,
...
- name: mongodb_collections
  props:
    - name: subscriptionId
      value: string
      description: Required parameter for the mongodb_collections resource.
...
```sql
DELETE FROM azure.cosmos_db.mongodb_collections
WHERE subscriptionId = '{{ subscriptionId }}' --required
AND resourceGroupName = '{{ resourceGroupName }}' --required
AND accountName = '{{ accountName }}' --required
AND databaseName = '{{ databaseName }}' --required
