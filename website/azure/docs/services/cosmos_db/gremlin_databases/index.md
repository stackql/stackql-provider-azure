...
Creates, updates, deletes, gets or lists a <code>gremlin_databases</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><code>gremlin_databases</code></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.cosmos_db.gremlin_databases" /></td></tr>
</tbody></table>
...
The Gremlin database property was retrieved successfully.
...
The Gremlin database properties were retrieved successfully.
...
```sql
INSERT INTO azure.cosmos_db.gremlin_databases (
data__properties,
data__location,
data__tags,
data__identity,
...
- name: gremlin_databases
  props:
    - name: subscriptionId
      value: string
      description: Required parameter for the gremlin_databases resource.
...
```sql
DELETE FROM azure.cosmos_db.gremlin_databases
WHERE subscriptionId = '{{ subscriptionId }}' --required
AND resourceGroupName = '{{ resourceGroupName }}' --required
AND accountName = '{{ accountName }}' --required
AND databaseName = '{{ databaseName }}' --required
