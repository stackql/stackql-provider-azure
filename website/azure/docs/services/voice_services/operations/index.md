...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.voice_services.operations" /></td></tr>
</tbody></table>
...
<tr>
    <td><a href="#check_local_name_availability"><CopyableCode code="check_local_name_availability" /></a></td>
...
isDataAction,
origin
FROM azure.voice_services.operations
;
```
</TabItem>
</Tabs>
...
<Tabs
    defaultValue="check_local_name_availability"
    values={[
        { label: 'check_local_name_availability', value: 'check_local_name_availability' }
    ]}
>
<TabItem value="check_local_name_availability">

Check whether the resource name is available in the given region.

```sql
EXEC azure.voice_services.operations.check_local_name_availability 
