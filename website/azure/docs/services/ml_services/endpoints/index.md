...
<tr>
    ...
    <td><a href="#parameter-endpointType"><code>endpointType</code></a>, <a href="#parameter-includeInferenceEndpoints"><code>includeInferenceEndpoints</code></a>, <a href="#parameter-$skip"><code>$skip</code></a>, <a href="#parameter-$expand"><code>$expand</code></a></td>
    <td></td>
</tr>
<tr>
...
<tr id="parameter-$expand">
    ...
    <td><code>string</code></td>
    <td>Whether the endpoint resource will be expand to include deployment information, e.g. $expand=deployments</td>
</tr>
...
<tr id="parameter-includeInferenceEndpoints">
    <td><CopyableCode code="includeInferenceEndpoints" /></td>
...
AND includeInferenceEndpoints = '{{ includeInferenceEndpoints }}'
AND $skip = '{{ $skip }}'
AND $expand = '{{ $expand }}'
;
```
