--- 
title: featurestore_entity_containers
hide_title: false
...
Creates, updates, deletes, gets or lists a <code>featurestore_entity_containers</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><code>featurestore_entity_containers</code></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.ml_services.featurestore_entity_containers" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>[Required] Additional attributes of the entity. (x-ms-client-name: FeaturestoreEntityContainerProperties)</td>
</tr>
</tbody>
</table>
</TabItem>
...
<tr id="parameter-description">
    ...
    <td><code>string</code></td>
    <td>description for the featurestore entity</td>
</tr>
...
<tr id="parameter-name">
    <td><CopyableCode code="name" /></td>
    <td><code>string</code></td>
    <td>name for the featurestore entity</td>
</tr>
...
SELECT
properties
FROM azure.ml_services.featurestore_entity_containers
...
```sql
INSERT INTO azure.ml_services.featurestore_entity_containers (
data__properties,
subscriptionId,
resourceGroupName,
workspaceName,
...
- name: featurestore_entity_containers
  props:
    - name: subscriptionId
      value: string
      description: Required parameter for the featurestore_entity_containers resource.
...
```sql
DELETE FROM azure.ml_services.featurestore_entity_containers
WHERE subscriptionId = '{{ subscriptionId }}' --required
AND resourceGroupName = '{{ resourceGroupName }}' --required
AND workspaceName = '{{ workspaceName }}' --required
