...
<tr>
    ...
    <td>[Required] Additional attributes of the entity. (x-ms-client-name: MarketplaceSubscriptionProperties)</td>
</tr>
</tbody>
</table>
</TabItem>
...
<tr id="parameter-name">
    ...
    <td>Marketplace Subscription name.</td>
</tr>
...
- name: marketplace_subscriptions
  props:
    - name: subscriptionId
      value: string
      description: Required parameter for the marketplace_subscriptions resource.
