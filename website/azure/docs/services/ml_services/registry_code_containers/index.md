...
<tr>
    ...
    <td>[Required] Additional attributes of the entity. (x-ms-client-name: CodeContainerProperties)</td>
</tr>
</tbody>
</table>
</TabItem>
...
<tr>
    ...
    <td><a href="#parameter-subscriptionId"><code>subscriptionId</code></a>, <a href="#parameter-resourceGroupName"><code>resourceGroupName</code></a>, <a href="#parameter-registryName"><code>registryName</code></a>, <a href="#parameter-codeName"><code>codeName</code></a>, <a href="#parameter-data__properties"><code>data__properties</code></a></td>
    <td></td>
    <td></td>
</tr>
<tr>
...
- name: registry_code_containers
  props:
    - name: subscriptionId
      value: string
      description: Required parameter for the registry_code_containers resource.
