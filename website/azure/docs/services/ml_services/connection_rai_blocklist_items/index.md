...
<tr>
    ...
    <td>RAI Custom Blocklist Item properties.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><a href="#parameter-subscriptionId"><code>subscriptionId</code></a>, <a href="#parameter-resourceGroupName"><code>resourceGroupName</code></a>, <a href="#parameter-workspaceName"><code>workspaceName</code></a>, <a href="#parameter-connectionName"><code>connectionName</code></a>, <a href="#parameter-raiBlocklistName"><code>raiBlocklistName</code></a>, <a href="#parameter-raiBlocklistItemName"><code>raiBlocklistItemName</code></a>, <a href="#parameter-data__properties"><code>data__properties</code></a></td>
    <td></td>
    <td></td>
</tr>
<tr>
...
<tr>
    <td><a href="#add_bulk"><CopyableCode code="add_bulk" /></a></td>
...
<tr id="parameter-raiBlocklistItemName">
    ...
    <td><code>string</code></td>
    <td>Name of the RaiBlocklist Item</td>
</tr>
...
- name: connection_rai_blocklist_items
  props:
    - name: subscriptionId
      value: string
      description: Required parameter for the connection_rai_blocklist_items resource.
...
<Tabs
    defaultValue="add_bulk"
    values={[
        { label: 'add_bulk', value: 'add_bulk' }
    ]}
>
<TabItem value="add_bulk">

The request was successful; the request was well-formed and received properly.

```sql
EXEC azure.ml_services.connection_rai_blocklist_items.add_bulk 
