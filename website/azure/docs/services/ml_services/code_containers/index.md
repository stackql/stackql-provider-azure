...
Creates, updates, deletes, gets or lists a <code>code_containers</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><code>code_containers</code></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.ml_services.code_containers" /></td></tr>
</tbody></table>
...
```sql
INSERT INTO azure.ml_services.code_containers (
data__properties,
subscriptionId,
resourceGroupName,
workspaceName,
...
- name: code_containers
  props:
    - name: subscriptionId
      value: string
      description: Required parameter for the code_containers resource.
...
```sql
DELETE FROM azure.ml_services.code_containers
WHERE subscriptionId = '{{ subscriptionId }}' --required
AND resourceGroupName = '{{ resourceGroupName }}' --required
AND workspaceName = '{{ workspaceName }}' --required
AND name = '{{ name }}' --required
