...
Creates, updates, deletes, gets or lists an <code>environment_versions</code> resource.
...
- name: environment_versions
  props:
    - name: subscriptionId
      value: string
      description: Required parameter for the environment_versions resource.
...
```sql
EXEC azure.ml_services.environment_versions.publish 
