...
Creates, updates, deletes, gets or lists a <code>model_containers</code> resource.
...
<tr>
    ...
    <td><a href="#parameter-$skip"><code>$skip</code></a>, <a href="#parameter-count"><code>count</code></a>, <a href="#parameter-listViewType"><code>listViewType</code></a></td>
    <td></td>
</tr>
<tr>
...
```sql
INSERT INTO azure.ml_services.model_containers (
data__properties,
subscriptionId,
resourceGroupName,
workspaceName,
...
- name: model_containers
  props:
    - name: subscriptionId
      value: string
      description: Required parameter for the model_containers resource.
...
```sql
DELETE FROM azure.ml_services.model_containers
WHERE subscriptionId = '{{ subscriptionId }}' --required
AND resourceGroupName = '{{ resourceGroupName }}' --required
AND workspaceName = '{{ workspaceName }}' --required
AND name = '{{ name }}' --required
