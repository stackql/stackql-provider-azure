...
Creates, updates, deletes, gets or lists an <code>endpoint_deployments</code> resource.
...
<Tabs
    ...
    values={[
        ...
        { label: 'get_in_workspace', value: 'get_in_workspace' }
    ]}
>
<TabItem value="get">
...
<TabItem value="get_in_workspace">
...
<tr>
    <td><a href="#get_in_workspace"><CopyableCode code="get_in_workspace" /></a></td>
    <td><CopyableCode code="select" /></td>
...
- name: endpoint_deployments
  props:
    - name: subscriptionId
      value: string
      description: Required parameter for the endpoint_deployments resource.
