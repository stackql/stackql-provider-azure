...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.ml_services.model_versions" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><a href="#parameter-$skip"><code>$skip</code></a>, <a href="#parameter-$orderBy"><code>$orderBy</code></a>, <a href="#parameter-$top"><code>$top</code></a>, <a href="#parameter-version"><code>version</code></a>, <a href="#parameter-description"><code>description</code></a>, <a href="#parameter-offset"><code>offset</code></a>, <a href="#parameter-tags"><code>tags</code></a>, <a href="#parameter-properties"><code>properties</code></a>, <a href="#parameter-feed"><code>feed</code></a>, <a href="#parameter-listViewType"><code>listViewType</code></a></td>
    <td></td>
</tr>
<tr>
...
<tr id="parameter-feed">
    <td><CopyableCode code="feed" /></td>
    <td><code>string</code></td>
...
<tr id="parameter-offset">
    ...
    <td><code>integer (int32)</code></td>
    <td>Number of initial results to skip.</td>
</tr>
...
```sql
INSERT INTO azure.ml_services.model_versions (
data__properties,
subscriptionId,
resourceGroupName,
workspaceName,
...
```sql
DELETE FROM azure.ml_services.model_versions
WHERE subscriptionId = '{{ subscriptionId }}' --required
AND resourceGroupName = '{{ resourceGroupName }}' --required
AND workspaceName = '{{ workspaceName }}' --required
AND name = '{{ name }}' --required
...
```sql
EXEC azure.ml_services.model_versions.publish 
