--- 
title: private_endpoint_connections_for_edms
hide_title: false
...
Creates, updates, deletes, gets or lists a <code>private_endpoint_connections_for_edms</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><code>private_endpoint_connections_for_edms</code></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.security_and_compliance.private_endpoint_connections_for_edms" /></td></tr>
</tbody></table>
...
systemData,
type
FROM azure.security_and_compliance.private_endpoint_connections_for_edms
...
```sql
INSERT INTO azure.security_and_compliance.private_endpoint_connections_for_edms (
data__properties,
subscriptionId,
resourceGroupName,
resourceName,
...
- name: private_endpoint_connections_for_edms
  props:
    - name: subscriptionId
      value: string
      description: Required parameter for the private_endpoint_connections_for_edms resource.
...
```sql
DELETE FROM azure.security_and_compliance.private_endpoint_connections_for_edms
WHERE subscriptionId = '{{ subscriptionId }}' --required
AND resourceGroupName = '{{ resourceGroupName }}' --required
AND resourceName = '{{ resourceName }}' --required
AND privateEndpointConnectionName = '{{ privateEndpointConnectionName }}' --required
