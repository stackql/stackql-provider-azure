...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.security_and_compliance.private_endpoint_connections_for_mip_policy_syncs" /></td></tr>
</tbody></table>
...
```sql
INSERT INTO azure.security_and_compliance.private_endpoint_connections_for_mip_policy_syncs (
data__properties,
subscriptionId,
resourceGroupName,
resourceName,
...
```sql
DELETE FROM azure.security_and_compliance.private_endpoint_connections_for_mip_policy_syncs
WHERE subscriptionId = '{{ subscriptionId }}' --required
AND resourceGroupName = '{{ resourceGroupName }}' --required
AND resourceName = '{{ resourceName }}' --required
AND privateEndpointConnectionName = '{{ privateEndpointConnectionName }}' --required
