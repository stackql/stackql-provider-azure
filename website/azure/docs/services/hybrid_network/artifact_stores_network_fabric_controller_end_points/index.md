...
Creates, updates, deletes, gets or lists an <code>artifact_stores_network_fabric_controller_end_points</code> resource.
...
<tr>
    ...
    <td></td>
    <td>Delete network fabric controllers on artifact stores</td>
</tr>
</tbody>
</table>
