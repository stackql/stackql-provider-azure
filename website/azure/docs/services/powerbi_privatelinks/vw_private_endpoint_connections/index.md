...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.powerbi_privatelinks.vw_private_endpoint_connections" /></td></tr>
</tbody></table>
...
WHERE subscriptionId = 'replace-me' AND resourceGroupName = 'replace-me' AND azureResourceName = 'replace-me';
```
