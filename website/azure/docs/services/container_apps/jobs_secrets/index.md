...
<tr>
    ...
    <td><code>string</code></td>
    <td>Resource ID of a managed identity to authenticate with Azure Key Vault, or System to use a system-assigned identity.</td>
</tr>
<tr>
    <td><CopyableCode code="keyVaultUrl" /></td>
    <td><code>string</code></td>
    <td>Azure Key Vault URL pointing to the secret referenced by the container app.</td>
</tr>
<tr>
