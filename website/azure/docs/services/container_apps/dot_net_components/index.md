...
<tr>
    ...
    <td>.NET Component resource specific properties</td>
</tr>
</tbody>
</table>
</TabItem>
...
<tr>
    ...
    <td><a href="#parameter-subscriptionId"><code>subscriptionId</code></a>, <a href="#parameter-resourceGroupName"><code>resourceGroupName</code></a>, <a href="#parameter-environmentName"><code>environmentName</code></a>, <a href="#parameter-name"><code>name</code></a></td>
    <td></td>
    <td>Creates or updates a .NET Component in a Managed Environment.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-subscriptionId"><code>subscriptionId</code></a>, <a href="#parameter-resourceGroupName"><code>resourceGroupName</code></a>, <a href="#parameter-environmentName"><code>environmentName</code></a>, <a href="#parameter-name"><code>name</code></a></td>
    <td></td>
    <td>Patches a .NET Component using JSON Merge Patch</td>
</tr>
<tr>
...
<tr id="parameter-name">
    ...
    <td><code>string</code></td>
    <td>Name of the .NET Component.</td>
</tr>
...
- name: dot_net_components
  props:
    - name: subscriptionId
      value: string (uuid)
      description: Required parameter for the dot_net_components resource.
