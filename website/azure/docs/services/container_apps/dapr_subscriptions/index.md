...
<tr>
    ...
    <td>Dapr PubSub Event Subscription resource specific properties</td>
</tr>
</tbody>
</table>
</TabItem>
...
<tr>
    ...
    <td><a href="#parameter-subscriptionId"><code>subscriptionId</code></a>, <a href="#parameter-resourceGroupName"><code>resourceGroupName</code></a>, <a href="#parameter-environmentName"><code>environmentName</code></a>, <a href="#parameter-name"><code>name</code></a></td>
    <td></td>
    <td>Creates or updates a Dapr subscription in a Managed Environment.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-subscriptionId"><code>subscriptionId</code></a>, <a href="#parameter-resourceGroupName"><code>resourceGroupName</code></a>, <a href="#parameter-environmentName"><code>environmentName</code></a>, <a href="#parameter-name"><code>name</code></a></td>
    <td></td>
    <td>Delete a Dapr subscription from a Managed Environment.</td>
</tr>
</tbody>
</table>
...
<tr id="parameter-name">
    ...
    <td><code>string</code></td>
    <td>Name of the Dapr subscription.</td>
</tr>
...
- name: dapr_subscriptions
  props:
    - name: subscriptionId
      value: string (uuid)
      description: Required parameter for the dapr_subscriptions resource.
