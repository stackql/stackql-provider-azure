...
<tr>
    ...
    <td>The integration account partner properties.</td>
</tr>
<tr>
...
<tr id="parameter-$filter">
    ...
    <td><code>string</code></td>
    <td>The filter to apply on the operation. Options for filters include: PartnerType.</td>
</tr>
<tr id="parameter-$top">
