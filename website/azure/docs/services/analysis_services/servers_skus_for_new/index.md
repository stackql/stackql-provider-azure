...
<tr>
    ...
    <td>Name of the SKU level.</td>
</tr>
<tr>
    <td><CopyableCode code="capacity" /></td>
    <td><code>integer (int32)</code></td>
    <td>The number of instances in the read only query pool.</td>
</tr>
<tr>
    <td><CopyableCode code="tier" /></td>
    <td><code>string</code></td>
    <td>The name of the Azure pricing tier to which the SKU applies.</td>
</tr>
</tbody>
</table>
</TabItem>
...
<tr>
    ...
    <td></td>
    <td>Lists eligible SKUs for Analysis Services resource provider.</td>
</tr>
</tbody>
</table>
