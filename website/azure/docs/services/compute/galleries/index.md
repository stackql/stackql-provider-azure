...
<tr>
    ...
    <td>Describes the properties of a Shared Image Gallery.</td>
</tr>
<tr>
...
<tr id="parameter-galleryName">
    ...
    <td><code>string</code></td>
    <td>The name of the Shared Image Gallery to be deleted.</td>
</tr>
...
<tr id="parameter-$expand">
    ...
    <td><code>string</code></td>
    <td>The expand query option to apply on the operation.</td>
</tr>
<tr id="parameter-$select">
    <td><CopyableCode code="$select" /></td>
    <td><code>string</code></td>
    <td>The select expression to apply on the operation.</td>
</tr>
</tbody>
</table>
