...
<tr>
    ...
    <td><a href="#parameter-location"><code>location</code></a>, <a href="#parameter-osVersionName"><code>osVersionName</code></a>, <a href="#parameter-subscriptionId"><code>subscriptionId</code></a></td>
    <td></td>
    <td>Gets properties of a guest operating system version that can be specified in the XML service configuration (.cscfg) for a cloud service.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Gets a list of all guest operating system versions available to be specified in the XML service configuration (.cscfg) for a cloud service. Use nextLink property in the response to get the next page of OS versions. Do this till nextLink is null to fetch all the OS versions.</td>
</tr>
</tbody>
</table>
...
<tr id="parameter-location">
    <td><CopyableCode code="location" /></td>
    <td><code>string</code></td>
    <td>Name of the location that the OS versions pertain to.</td>
</tr>
<tr id="parameter-osVersionName">
    <td><CopyableCode code="osVersionName" /></td>
    <td><code>string</code></td>
    <td>Name of the OS version.</td>
</tr>
