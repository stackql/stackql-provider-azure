...
Creates, updates, deletes, gets or lists a <code>virtual_machine_images_edge_zone_publishers</code> resource.
...
```sql
EXEC azure.compute.virtual_machine_images_edge_zone_publishers.list 
