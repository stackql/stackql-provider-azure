...
Successfully retrieved details of specified server advisor.
...
<tr>
    ...
    <td><a href="#parameter-resourceGroupName"><code>resourceGroupName</code></a>, <a href="#parameter-serverName"><code>serverName</code></a>, <a href="#parameter-advisorName"><code>advisorName</code></a>, <a href="#parameter-subscriptionId"><code>subscriptionId</code></a></td>
    <td></td>
...
<tr id="parameter-advisorName">
    ...
    <td><code>string</code></td>
    <td>The name of the Server Advisor.</td>
</tr>
...
```sql
EXEC azure.sql.server_advisors.list_by_server 
@resourceGroupName='{{ resourceGroupName }}' --required, 
