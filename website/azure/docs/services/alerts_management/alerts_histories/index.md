...
Creates, updates, deletes, gets or lists an <code>alerts_histories</code> resource.
...
<tr>
    ...
    <td>Properties of the alert modification item.</td>
</tr>
<tr>
...
<tr>
    ...
    <td></td>
    <td>Get the history of an alert, which captures any monitor condition changes (Fired/Resolved) and alert state changes (New/Acknowledged/Closed).</td>
</tr>
</tbody>
</table>
