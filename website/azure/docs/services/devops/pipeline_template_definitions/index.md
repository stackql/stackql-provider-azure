...
<tr>
    ...
    <td>Unique identifier of the pipeline template.</td>
</tr>
<tr>
    <td><CopyableCode code="description" /></td>
    <td><code>string</code></td>
    <td>Description of the pipeline enabled by the template.</td>
</tr>
<tr>
    <td><CopyableCode code="inputs" /></td>
    <td><code>array</code></td>
    <td>List of input parameters required by the template to create a pipeline.</td>
</tr>
</tbody>
</table>
</TabItem>
...
<tr>
    ...
    <td></td>
    <td></td>
    <td>Lists all pipeline templates which can be used to configure an Azure Pipeline.</td>
</tr>
</tbody>
</table>
