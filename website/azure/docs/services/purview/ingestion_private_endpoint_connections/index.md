...
Creates, updates, deletes, gets or lists an <code>ingestion_private_endpoint_connections</code> resource.
...
<tr>
    ...
    <td>Lists all ingestion private endpoint connections</td>
</tr>
</tbody>
</table>
