...
Creates, updates, deletes, gets or lists an <code>ingestion_private_endpoint_connections_status</code> resource.
...
<tr>
    ...
    <td>Update ingestion private endpoint connection status</td>
</tr>
</tbody>
</table>
