...
<tr>
    ...
    <td>Resource ID of the streaming job.</td>
</tr>
<tr>
    <td><CopyableCode code="jobState" /></td>
    <td><code>string</code></td>
    <td>The current execution state of the streaming job.</td>
</tr>
<tr>
    <td><CopyableCode code="streamingUnits" /></td>
    <td><code>integer (int32)</code></td>
    <td>The number of streaming units that are used by the streaming job.</td>
</tr>
</tbody>
</table>
</TabItem>
