...
<tr>
    ...
    <td><a href="#parameter-resourceGroupName"><code>resourceGroupName</code></a>, <a href="#parameter-name"><code>name</code></a>, <a href="#parameter-environmentName"><code>environmentName</code></a>, <a href="#parameter-subscriptionId"><code>subscriptionId</code></a></td>
    <td></td>
    <td>Description for Creates or updates the app settings of a static site build.</td>
</tr>
</tbody>
</table>
...
- name: static_site_build_app_settings
  props:
    - name: resourceGroupName
      value: string
      description: Required parameter for the static_site_build_app_settings resource.
    - name: name
      value: string
      description: Required parameter for the static_site_build_app_settings resource.
