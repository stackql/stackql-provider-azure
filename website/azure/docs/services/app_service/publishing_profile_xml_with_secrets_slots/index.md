...
<tr>
    ...
    <td></td>
    <td>Description for Gets the publishing profile for an app (or deployment slot, if specified).</td>
</tr>
</tbody>
</table>
...
<tr id="parameter-slot">
    ...
    <td><code>string</code></td>
    <td>Name of the deployment slot. If a slot is not specified, the API will get the publishing profile for the production slot.</td>
</tr>
...
```sql
EXEC azure.app_service.publishing_profile_xml_with_secrets_slots.list 
