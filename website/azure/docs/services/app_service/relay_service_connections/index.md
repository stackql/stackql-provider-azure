...
<tr>
    ...
    <td><a href="#parameter-resourceGroupName"><code>resourceGroupName</code></a>, <a href="#parameter-name"><code>name</code></a>, <a href="#parameter-entityName"><code>entityName</code></a>, <a href="#parameter-subscriptionId"><code>subscriptionId</code></a></td>
    <td></td>
...
- name: relay_service_connections
  props:
    - name: resourceGroupName
      value: string
      description: Required parameter for the relay_service_connections resource.
    - name: name
      value: string
      description: Required parameter for the relay_service_connections resource.
    - name: entityName
