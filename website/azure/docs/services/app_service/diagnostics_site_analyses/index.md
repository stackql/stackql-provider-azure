--- 
title: diagnostics_site_analyses
hide_title: false
hide_table_of_contents: false
keywords:
  - diagnostics_site_analyses
  - app_service
  - azure
...
Creates, updates, deletes, gets or lists a <code>diagnostics_site_analyses</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><code>diagnostics_site_analyses</code></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.app_service.diagnostics_site_analyses" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>AnalysisDefinition resource specific properties</td>
</tr>
<tr>
...
<tr>
    ...
    <td></td>
    <td>Description for Get Site Analysis</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Description for Get Site Analyses</td>
</tr>
</tbody>
</table>
...
properties,
type
FROM azure.app_service.diagnostics_site_analyses
WHERE resourceGroupName = '{{ resourceGroupName }}' -- required
AND siteName = '{{ siteName }}' -- required
AND diagnosticCategory = '{{ diagnosticCategory }}' -- required
AND analysisName = '{{ analysisName }}' -- required
