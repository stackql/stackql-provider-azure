...
<tr id="parameter-slot">
    ...
    <td><code>string</code></td>
    <td>Name of the deployment slot. If a slot is not specified, the API will add or update connections for the production slot.</td>
</tr>
...
- name: swift_virtual_network_connection_with_check_slots
  props:
    - name: resourceGroupName
      value: string
      description: Required parameter for the swift_virtual_network_connection_with_check_slots resource.
    - name: name
      value: string
      description: Required parameter for the swift_virtual_network_connection_with_check_slots resource.
    - name: slot
