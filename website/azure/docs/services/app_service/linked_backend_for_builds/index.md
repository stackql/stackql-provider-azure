--- 
title: linked_backend_for_builds
hide_title: false
hide_table_of_contents: false
keywords:
  - linked_backend_for_builds
  - app_service
  - azure
...
Creates, updates, deletes, gets or lists a <code>linked_backend_for_builds</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><code>linked_backend_for_builds</code></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.app_service.linked_backend_for_builds" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>StaticSiteLinkedBackendARMResource resource specific properties</td>
</tr>
<tr>
...
<tr id="parameter-linkedBackendName">
    ...
    <td><code>string</code></td>
    <td>Name of the linked backend that should be retrieved</td>
</tr>
...
properties,
type
FROM azure.app_service.linked_backend_for_builds
WHERE resourceGroupName = '{{ resourceGroupName }}' -- required
AND name = '{{ name }}' -- required
AND environmentName = '{{ environmentName }}' -- required
AND linkedBackendName = '{{ linkedBackendName }}' -- required
