...
Creates, updates, deletes, gets or lists an <code>environments_app_service_plans</code> resource.
...
<tr>
    ...
    <td></td>
    <td>Description for Get all App Service plans in an App Service Environment.</td>
</tr>
</tbody>
</table>
