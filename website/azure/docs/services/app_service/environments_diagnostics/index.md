...
Creates, updates, deletes, gets or lists an <code>environments_diagnostics</code> resource.
...
<tr>
    ...
    <td></td>
    <td>Description for Get diagnostic information for an App Service Environment.</td>
</tr>
</tbody>
</table>
...
```sql
EXEC azure.app_service.environments_diagnostics.list 
