...
<tr id="parameter-slot">
    ...
    <td><code>string</code></td>
    <td>Name of the deployment slot. If a slot is not specified, the API will update configuration for the production slot.</td>
</tr>
...
- name: configuration_slots
  props:
    - name: resourceGroupName
      value: string
      description: Required parameter for the configuration_slots resource.
    - name: name
      value: string
      description: Required parameter for the configuration_slots resource.
    - name: slot
