...
Creates, updates, deletes, gets or lists an <code>instance_ms_deploy_operations</code> resource.
...
- name: instance_ms_deploy_operations
  props:
    - name: resourceGroupName
      value: string
      description: Required parameter for the instance_ms_deploy_operations resource.
    - name: name
      value: string
      description: Required parameter for the instance_ms_deploy_operations resource.
    - name: instanceId
