...
Creates, updates, deletes, gets or lists an <code>environments_multi_role_pool_skus</code> resource.
...
<tr>
    ...
    <td></td>
    <td>Description for Get available SKUs for scaling a multi-role pool.</td>
</tr>
</tbody>
</table>
