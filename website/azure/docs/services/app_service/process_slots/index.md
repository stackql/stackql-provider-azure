...
Creates, updates, deletes, gets or lists a <code>process_slots</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><code>process_slots</code></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.app_service.process_slots" /></td></tr>
</tbody></table>
...
properties,
type
FROM azure.app_service.process_slots
...
```sql
DELETE FROM azure.app_service.process_slots
WHERE resourceGroupName = '{{ resourceGroupName }}' --required
AND name = '{{ name }}' --required
AND processId = '{{ processId }}' --required
AND slot = '{{ slot }}' --required
