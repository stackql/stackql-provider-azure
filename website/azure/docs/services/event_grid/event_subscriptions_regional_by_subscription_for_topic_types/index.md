...
Creates, updates, deletes, gets or lists an <code>event_subscriptions_regional_by_subscription_for_topic_types</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><code>event_subscriptions_regional_by_subscription_for_topic_types</code></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.event_grid.event_subscriptions_regional_by_subscription_for_topic_types" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><a href="#parameter-subscriptionId"><code>subscriptionId</code></a>, <a href="#parameter-location"><code>location</code></a>, <a href="#parameter-topicTypeName"><code>topicTypeName</code></a></td>
    <td><a href="#parameter-$filter"><code>$filter</code></a>, <a href="#parameter-$top"><code>$top</code></a></td>
    <td>List all event subscriptions from the given location under a specific Azure subscription and topic type.</td>
</tr>
</tbody>
</table>
...
<tr id="parameter-topicTypeName">
    <td><CopyableCode code="topicTypeName" /></td>
    <td><code>string</code></td>
...
systemData,
type
FROM azure.event_grid.event_subscriptions_regional_by_subscription_for_topic_types
WHERE subscriptionId = '{{ subscriptionId }}' -- required
AND location = '{{ location }}' -- required
AND topicTypeName = '{{ topicTypeName }}' -- required
AND $filter = '{{ $filter }}'
AND $top = '{{ $top }}'
;
```
