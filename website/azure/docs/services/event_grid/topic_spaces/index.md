...
<tr>
    ...
    <td>The properties of topic space.</td>
</tr>
<tr>
    <td><CopyableCode code="systemData" /></td>
    <td><code>object</code></td>
    <td>The system metadata relating to the TopicSpace resource.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><a href="#parameter-subscriptionId"><code>subscriptionId</code></a>, <a href="#parameter-resourceGroupName"><code>resourceGroupName</code></a>, <a href="#parameter-namespaceName"><code>namespaceName</code></a>, <a href="#parameter-topicSpaceName"><code>topicSpaceName</code></a></td>
    <td></td>
    <td>Get properties of a topic space.</td>
</tr>
<tr>
    ...
    <td>Get all the topic spaces under a namespace.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-subscriptionId"><code>subscriptionId</code></a>, <a href="#parameter-resourceGroupName"><code>resourceGroupName</code></a>, <a href="#parameter-namespaceName"><code>namespaceName</code></a>, <a href="#parameter-topicSpaceName"><code>topicSpaceName</code></a></td>
    <td></td>
    <td>Create or update a topic space with the specified parameters.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-subscriptionId"><code>subscriptionId</code></a>, <a href="#parameter-resourceGroupName"><code>resourceGroupName</code></a>, <a href="#parameter-namespaceName"><code>namespaceName</code></a>, <a href="#parameter-topicSpaceName"><code>topicSpaceName</code></a></td>
    <td></td>
    <td>Delete an existing topic space.</td>
</tr>
</tbody>
</table>
...
<tr id="parameter-topicSpaceName">
    <td><CopyableCode code="topicSpaceName" /></td>
    <td><code>string</code></td>
    <td>Name of the Topic space.</td>
</tr>
...
AND topicSpaceName = '{{ topicSpaceName }}' -- required
;
```
</TabItem>
<TabItem value="list_by_namespace">
