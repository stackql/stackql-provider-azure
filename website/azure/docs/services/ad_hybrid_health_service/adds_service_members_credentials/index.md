...
Creates, updates, deletes, gets or lists an <code>adds_service_members_credentials</code> resource.
...
The list of server credentials.
...
identifier,
type
FROM azure.ad_hybrid_health_service.adds_service_members_credentials
