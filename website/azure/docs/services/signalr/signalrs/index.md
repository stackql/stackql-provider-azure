...
- name: signalrs
  props:
    - name: subscriptionId
      value: string (uuid)
      description: Required parameter for the signalrs resource.
    ...
    - name: kind
      ...
      valid_values: ['SignalR', 'RawWebSockets']
    - name: identity
      value: object
      description: |
...
```sql
EXEC azure.signalr.signalrs.check_name_availability 
...
```sql
EXEC azure.signalr.signalrs.regenerate_key 
@subscriptionId='{{ subscriptionId }}' --required, 
...
```sql
EXEC azure.signalr.signalrs.restart 
@subscriptionId='{{ subscriptionId }}' --required, 
@resourceGroupName='{{ resourceGroupName }}' --required, 
@resourceName='{{ resourceName }}' --required
;
