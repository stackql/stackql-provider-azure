...
<tr>
    ...
    <td>The primary key for accessing the Maps REST APIs.</td>
</tr>
<tr>
    <td><CopyableCode code="primaryKeyLastUpdated" /></td>
    <td><code>string</code></td>
    <td>The last updated date and time of the primary key.</td>
</tr>
<tr>
    <td><CopyableCode code="secondaryKey" /></td>
    <td><code>string</code></td>
    <td>The secondary key for accessing the Maps REST APIs.</td>
</tr>
<tr>
    <td><CopyableCode code="secondaryKeyLastUpdated" /></td>
    <td><code>string</code></td>
    <td>The last updated date and time of the secondary key.</td>
</tr>
</tbody>
</table>
</TabItem>
