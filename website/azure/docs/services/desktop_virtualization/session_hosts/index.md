...
<tr>
    ...
    <td>Detailed properties for SessionHost</td>
</tr>
<tr>
...
Successfully retrieved session hosts in host pool.
...
<tr>
    ...
    <td><a href="#parameter-pageSize"><code>pageSize</code></a>, <a href="#parameter-isDescending"><code>isDescending</code></a>, <a href="#parameter-initialSkip"><code>initialSkip</code></a>, <a href="#parameter-vmPath"><code>vmPath</code></a></td>
...
<tr>
    <td><a href="#retry_provisioning"><CopyableCode code="retry_provisioning" /></a></td>
    <td><CopyableCode code="exec" /></td>
    <td><a href="#parameter-subscriptionId"><code>subscriptionId</code></a>, <a href="#parameter-resourceGroupName"><code>resourceGroupName</code></a>, <a href="#parameter-hostPoolName"><code>hostPoolName</code></a>, <a href="#parameter-sessionHostName"><code>sessionHostName</code></a></td>
    <td></td>
    <td>Retry provisioning on a SessionHost.</td>
</tr>
</tbody>
</table>
...
<tr id="parameter-force">
    ...
    <td>Force flag to force sessionHost deletion even when userSession exists.</td>
</tr>
...
<tr id="parameter-vmPath">
    <td><CopyableCode code="vmPath" /></td>
    <td><code>string</code></td>
    <td>The path to the VM.</td>
</tr>
</tbody>
</table>
...
<Tabs
    defaultValue="retry_provisioning"
    values={[
        { label: 'retry_provisioning', value: 'retry_provisioning' }
    ]}
>
<TabItem value="retry_provisioning">
