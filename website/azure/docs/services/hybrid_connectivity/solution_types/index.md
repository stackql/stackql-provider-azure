...
<tr>
    ...
    <td><a href="#parameter-subscriptionId"><code>subscriptionId</code></a>, <a href="#parameter-resourceGroupName"><code>resourceGroupName</code></a>, <a href="#parameter-solutionType"><code>solutionType</code></a></td>
    <td></td>
...
<tr id="parameter-solutionType">
    <td><CopyableCode code="solutionType" /></td>
    <td><code>string</code></td>
    <td>Solution Type resource</td>
</tr>
...
AND solutionType = '{{ solutionType }}' -- required
;
```
</TabItem>
<TabItem value="list_by_resource_group">
