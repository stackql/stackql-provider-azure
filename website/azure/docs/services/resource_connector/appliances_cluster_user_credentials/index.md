...
Creates, updates, deletes, gets or lists an <code>appliances_cluster_user_credentials</code> resource.
...
<tr>
    ...
    <td>Contains the REP (rendezvous endpoint) and “Listener” access token from notification service (NS).</td>
</tr>
<tr>
...
<tr>
    ...
    <td></td>
    <td>Returns the cluster user credentials for the dedicated appliance.</td>
</tr>
</tbody>
</table>
