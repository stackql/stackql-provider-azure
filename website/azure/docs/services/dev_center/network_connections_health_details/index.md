...
<tr>
    ...
    <td>Health check status details properties.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><CopyableCode code="select" /></td>
    <td><a href="#parameter-subscriptionId"><code>subscriptionId</code></a>, <a href="#parameter-resourceGroupName"><code>resourceGroupName</code></a>, <a href="#parameter-networkConnectionName"><code>networkConnectionName</code></a></td>
    <td></td>
...
<tbody>
<tr id="parameter-networkConnectionName">
    <td><CopyableCode code="networkConnectionName" /></td>
    <td><code>string</code></td>
    <td>Name of the Network Connection that can be applied to a Pool.</td>
</tr>
...
AND networkConnectionName = '{{ networkConnectionName }}' -- required
;
```
</TabItem>
</Tabs>
