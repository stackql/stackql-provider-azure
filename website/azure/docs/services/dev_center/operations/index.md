...
<tr>
    <td><a href="#check_scoped_name_availability_execute"><CopyableCode code="check_scoped_name_availability_execute" /></a></td>
    <td><CopyableCode code="exec" /></td>
    <td><a href="#parameter-subscriptionId"><code>subscriptionId</code></a></td>
    <td></td>
    <td>Check the availability of name for resource</td>
...
isDataAction,
origin
FROM azure.dev_center.operations
;
```
</TabItem>
</Tabs>
...
<Tabs
    ...
    values={[
        ...
        { label: 'check_scoped_name_availability_execute', value: 'check_scoped_name_availability_execute' }
    ]}
>
...
```sql
EXEC azure.dev_center.operations.check_name_availability_execute 
...
<TabItem value="check_scoped_name_availability_execute">

Check the availability of name for resource

```sql
EXEC azure.dev_center.operations.check_scoped_name_availability_execute 
@subscriptionId='{{ subscriptionId }}' --required 
@@json=
'{
"name": "{{ name }}", 
