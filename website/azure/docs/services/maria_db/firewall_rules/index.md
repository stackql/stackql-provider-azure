...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.maria_db.firewall_rules" /></td></tr>
</tbody></table>
...
```sql
INSERT INTO azure.maria_db.firewall_rules (
data__properties,
subscriptionId,
resourceGroupName,
serverName,
...
```sql
DELETE FROM azure.maria_db.firewall_rules
WHERE subscriptionId = '{{ subscriptionId }}' --required
AND resourceGroupName = '{{ resourceGroupName }}' --required
AND serverName = '{{ serverName }}' --required
AND firewallRuleName = '{{ firewallRuleName }}' --required
