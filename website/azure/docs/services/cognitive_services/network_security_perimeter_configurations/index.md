...
<tr>
    ...
    <td>NSP Configuration properties.</td>
</tr>
</tbody>
</table>
</TabItem>
...
<tr>
    ...
    <td><a href="#parameter-resourceGroupName"><code>resourceGroupName</code></a>, <a href="#parameter-accountName"><code>accountName</code></a>, <a href="#parameter-subscriptionId"><code>subscriptionId</code></a>, <a href="#parameter-nspConfigurationName"><code>nspConfigurationName</code></a></td>
    <td></td>
...
<tr id="parameter-nspConfigurationName">
    <td><CopyableCode code="nspConfigurationName" /></td>
    <td><code>string</code></td>
    <td>The name of the NSP Configuration.</td>
</tr>
...
AND nspConfigurationName = '{{ nspConfigurationName }}' -- required
;
```
</TabItem>
<TabItem value="list">
...
@nspConfigurationName='{{ nspConfigurationName }}' --required
;
```
</TabItem>
</Tabs>
