...
Returns with a response body containing the subscription keys for the resource: key1<br />The first API key for authentication when client calls the API endpoint.<br /><br />key2<br />The second API key for authentication when client calls the API endpoint.
...
<tr>
    ...
    <td>Gets the value of key 1.</td>
</tr>
<tr>
    <td><CopyableCode code="key2" /></td>
    <td><code>string</code></td>
    <td>Gets the value of key 2.</td>
</tr>
</tbody>
</table>
</TabItem>
