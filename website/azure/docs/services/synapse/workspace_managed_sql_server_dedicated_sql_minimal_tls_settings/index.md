...
Successfully retrieved dedicated sql minimal tls settings.
...
<tr>
    ...
    <td><a href="#parameter-subscriptionId"><code>subscriptionId</code></a>, <a href="#parameter-resourceGroupName"><code>resourceGroupName</code></a>, <a href="#parameter-workspaceName"><code>workspaceName</code></a>, <a href="#parameter-dedicatedSQLminimalTlsSettingsName"><code>dedicatedSQLminimalTlsSettingsName</code></a></td>
    <td></td>
    <td>Get workspace managed sql server's minimal tls settings.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>List workspace managed sql server's minimal tls settings.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-subscriptionId"><code>subscriptionId</code></a>, <a href="#parameter-resourceGroupName"><code>resourceGroupName</code></a>, <a href="#parameter-workspaceName"><code>workspaceName</code></a>, <a href="#parameter-dedicatedSQLminimalTlsSettingsName"><code>dedicatedSQLminimalTlsSettingsName</code></a></td>
    <td></td>
    <td>Update workspace managed sql server's minimal tls settings.</td>
</tr>
</tbody>
</table>
...
<tbody>
<tr id="parameter-dedicatedSQLminimalTlsSettingsName">
    <td><CopyableCode code="dedicatedSQLminimalTlsSettingsName" /></td>
    <td><code>string</code></td>
    <td>The name of the dedicated sql minimal tls settings.</td>
</tr>
...
AND dedicatedSQLminimalTlsSettingsName = '{{ dedicatedSQLminimalTlsSettingsName }}' -- required
;
```
</TabItem>
<TabItem value="list">
