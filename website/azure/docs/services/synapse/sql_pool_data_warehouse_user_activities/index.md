...
<tr>
    ...
    <td><a href="#parameter-subscriptionId"><code>subscriptionId</code></a>, <a href="#parameter-resourceGroupName"><code>resourceGroupName</code></a>, <a href="#parameter-workspaceName"><code>workspaceName</code></a>, <a href="#parameter-sqlPoolName"><code>sqlPoolName</code></a>, <a href="#parameter-dataWarehouseUserActivityName"><code>dataWarehouseUserActivityName</code></a></td>
    <td></td>
    <td>Gets the user activities of a SQL pool which includes running and suspended queries</td>
</tr>
</tbody>
</table>
...
<tbody>
<tr id="parameter-dataWarehouseUserActivityName">
    <td><CopyableCode code="dataWarehouseUserActivityName" /></td>
    <td><code>string</code></td>
    <td>The activity name of the Sql pool. </td>
</tr>
...
AND dataWarehouseUserActivityName = '{{ dataWarehouseUserActivityName }}' -- required
;
```
</TabItem>
</Tabs>
